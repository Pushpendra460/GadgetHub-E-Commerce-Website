...
public class DemandDaoImpl implements DemandDao{
    public boolean addProduct(DemandPojo demandPojo){
        ...
        try{
            ...
            System.out.println("Error in Insert Product"+ex);
            ex.printStackTrace();
        }
    ...
    public List<DemandPojo> haveDemanded(String prodId) {
        ...
        ResultSet rs=null;
        try{
           ps=conn.prepareStatement("selecty * from userdemand where prodid=?");
            ...
            System.out.println("Error:"+ex.getMessage());
            System.out.println("Error in haveDemanded Product"+ex);
            ex.printStackTrace();
        }
        DBUtil.closeStatement(ps);
