...
%>
        ...
        <nav class="navbar navbar-expand-lg navbar-custom">
            <div class="container-fluid">
                <a class="navbar-brand" href="./AdminViewProductServlet">
                    <%=AppInfo.appName%>
                </a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav"
                        aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="./AdminViewProductServlet">Products</a>
                        </li>
...
>
    ...
    <%
        String searchServlet = "LandingServlet"; // Default for customers and guests
        if (session != null && "admin".equals(session.getAttribute("userType"))) {
            searchServlet = "AdminViewProductServlet";
        }
    %>
